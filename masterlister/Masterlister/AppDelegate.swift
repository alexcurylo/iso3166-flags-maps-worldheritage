...
final class AppDelegate: NSObject, NSApplicationDelegate {
    ...
    lazy var persistentContainer: NSPersistentContainer = {
         ...
         */
        let container = NSPersistentContainer(name: "Masterlister")
    ...
    @IBAction private func saveAction(_ sender: AnyObject?) {
        // Performs the save action for the application, which is to send
    ...
    func applicationShouldTerminate(_ sender: NSApplication) -> NSApplication.TerminateReply {
        ...
        do {
            ...
            let question = NSLocalizedString("Could not save changes while quitting. Quit anyway?",
                                             comment: "Quit without save question")
            let info = NSLocalizedString("Quitting now will lose any changes you have made",
                                         comment: "Quit without save info")
